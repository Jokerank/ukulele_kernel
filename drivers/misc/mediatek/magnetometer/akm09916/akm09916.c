	...
	switch (cmd)
	{
	   ...
	   case ECS_IOCTL_RESET:
		...
		case ECS_IOCTL_GET_DELAY_09916:
			...
			delay[0] = (int64_t)akmd_delay * 1000000;// 2017/06/02, Rickliu, fix coverity, modify from 'int' to 'int64_t'
			delay[1] = (int64_t)akmd_delay * 1000000;// 2017/06/02, Rickliu, fix coverity, modify from 'int' to 'int64_t' 
			delay[2] = (int64_t)akmd_delay * 1000000;// 2017/06/02, Rickliu, fix coverity, modify from 'int' to 'int64_t'
