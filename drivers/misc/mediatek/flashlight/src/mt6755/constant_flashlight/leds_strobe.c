...
// <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR.
...
// <<< 2016/09/06-dangyiwang. setting rear flashlight flash current setting
...
// <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR. Extern RT4505_i2c_client to kd_flashlightlist.c
...
// <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR. Extern RT4505_write_reg to kd_flashlightlist.c
...
{
		// <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR. flashlight driver init
        ...
        // Bit 06 ~ 00 : LED1 Torch Brightness Levels
        //
        ...
        chip_register_value   = 0x54;  // flash current = 995.8 mA = (Brightness Code x 11.725 mA) + 10.9 mA
        // >>> 2015/10/21-youchihwang. Camera Hardware Requirement, Setting rear flash mode current to 995.8 mA
        RT4505_write_reg (chip->client, chip_register_address, chip_register_value);
...
// <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR. create flashlight driver platform data
...
// <<< 2016/09/06-dangyiwang.  Porting flash light driver LM3644TTYFFR. register lm3644 to i2c
...
int FL_Enable(void)
{
        // <<< 2016/09/06-dangyiwang.  Porting flash light driver LM3644TTYFFR. front flashlight enable function
        u8 chip_register_address = 0x00;
        u8 chip_register_value   = 0x00;
...
int FL_Disable(void)
{
        // <<< 2016/09/06-dangyiwang. Porting flash light driver LM3644TTYFFR. front flashlight disable function.
        u8 chip_register_address = 0x00;
        u8 chip_register_value   = 0x00;
...
int FL_Init(void)
{
        // <<< 2016/09/06-dangyiwang.  Porting flash light driver LM3644TTYFFR. FL_Init ()
        FL_Disable ();
        // >>> 2016/09/06-dangyiwang.  Porting flash light driver LM3644TTYFFR. FL_Init ()
