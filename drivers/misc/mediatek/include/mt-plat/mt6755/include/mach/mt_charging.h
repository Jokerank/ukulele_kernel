...
// <<< 2017/04/28-youchihwang. Battery. The battery voltage configuration of the talking mode.
#if 0
...
#define CHECK_MAINTENANCE_TIME
#define MAINTENANCE_FIRST_STAGE_TIME_LIMIT     ( 60 * 60 * 60)
#define MAINTENANCE_SECOND_STAGE_TIME_LIMIT    (260 * 60 * 60)
// >>> 2016/11/21-youchihwang. Battery. FP002219. IEEE 1725 (Battery Safety). Maintenance
...
// <<< 2016/11/24-youchihwang. Battery. FP002219. IEEE 1725 (Battery Safety). Temperature.
    ...
    // original code
#else
#define    HIGH_TEMPERATURE_WARNNING_MESSAGE_TEMPERATURE  60
