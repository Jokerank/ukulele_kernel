...
//<2017/3/3-JessicaTseng, disable IPV6 support stable privacy address temporarily
	dflt->stable_secret.initialized = false;//true;
	all->stable_secret.initialized = false;//true;
//>2017/3/3-JessicaTseng	
