...
static int mtk_pcm_I2S0dl1_prepare(struct snd_pcm_substream *substream)
{
	...
	if (mPrepareDone == false) {
		...
		//	EnableI2SDivPower(AUDIO_APLL12_DIV2, true);//fix fm mclk close byoliverchen 20160316
		//	EnableI2SDivPower(AUDIO_APLL12_DIV4, true);//fix fm mclk close byoliverchen 20160316
		}
